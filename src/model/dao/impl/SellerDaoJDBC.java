...
public class SellerDaoJDBC implements SellerDao {
    ...
    private void sellerSet(Seller seller,PreparedStatement st) throws SQLException {
                st.setString(1,seller.getNome());
                st.setString(2,seller.getEmail());
                st.setDate(3,new java.sql.Date(seller.getBirthDDate().getTime()));
    ...
    public List<Seller> findAll() {
        ...
        ResultSet rs=null;
        try{
            st=connection.prepareStatement("SELECT seller.*,department.Name as DepName FROM seller INNER JOIN department ON seller.DepartmentId=department.Id ORDER BY Id");
            rs=st.executeQuery();
    ...
    public List<Seller> findByDepartment(Department department) {
        ...
        ResultSet rs=null;
        try{
            st=connection.prepareStatement("SELECT seller.*,department.Name as DepName FROM seller INNER JOIN department ON seller.DepartmentId=department.Id WHERE Department.id=? ORDER BY Name");
    ...
    private Seller instantiateSeller(ResultSet rs,Department department) throws SQLException {
        ...
        seller.setBirthDDate(rs.getDate("birthDate"));
